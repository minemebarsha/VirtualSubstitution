...
\begin{tikzpicture}
	...
	\draw[color=black] (-0.3222469468048416,-0.1881054754556408) node {$\frac{-1}{2}$};
	...
	\draw[color=black] (-1.0397018146733018,0.15241893284402286) node {$-\sqrt{2}+\epsilon$};
	\draw [color=black] (0.06769287701977207,0.)-- ++(-2.5pt,-2.5pt) -- ++(5.0pt,5.0pt) ++(-5.0pt,0) -- ++(5.0pt,-5.0pt);
	\draw[color=black] (0.25690923354881695,-0.25241893284402286) node {$0 + \epsilon$};
	\draw [fill=black] (1.5,0.) circle (1.5pt);
	\draw[color=black] (1.6319529948290257,-0.2271256509469844) node {$\sqrt{2} + \epsilon$};
	\end{scriptsize}
\end{tikzpicture}
